...
class MyModel(BertPreTrainedModel):
    def __init__(self, config,loss_fn: ClfDistillLossFunction):
        ...
        self.bert = AutoModel.from_pretrained('/raid/data/kay/mounted/model')
...
output_file = 'output_file_b2_ncbi'
...
def main2():
    ...
    for child in model.modules():
        if isinstance(child, nn.Linear):
            prune.l1_unstructured(child, name='weight', amount=0.2) # or random_unstructured, based on the type of pruning 
